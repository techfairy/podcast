...
<div class="studio-dialog-note" id="studio-modal-note">
      ...
      var spaces = {
        ...
        small: { title: 'Малая студия', copy: 'Камерный сетап для интервью на двух человек, экспертных разговоров и спокойных аудиовизуальных выпусков.', note: '2 спикера · отдельные дорожки', image: 'assets/images/studio-small-room-table.webp' },
